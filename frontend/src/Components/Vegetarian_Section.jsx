...
// // Import vegetarian images
// import PaneerButterMasala from "../assets/Veg/PaneerButterMasala.jpg";
// import VegetableBiryani from "../assets/Veg/VegetableBiryani.jpg";
// import PalakPaneer from "../assets/Veg/PalakPaneer.jpg";
// import CholeBhature from "../assets/Veg/CholeBhature.jpg";
// import AlooParatha from "../assets/Veg/AlooParatha.jpg";

// const vegData = [
//   { src: PaneerButterMasala, title: "Paneer Butter Masala", price: 220, rating: 4.8 },
//   { src: VegetableBiryani, title: "Vegetable Biryani", price: 180, rating: 4.7 },
//   { src: PalakPaneer, title: "Palak Paneer", price: 200, rating: 4.6 },
//   { src: CholeBhature, title: "Chole Bhature", price: 150, rating: 4.5 },
//   { src: AlooParatha, title: "Aloo Paratha", price: 120, rating: 4.4 },
// ];
...
//           <div className="absolute top-3 left-3 bg-green-500 text-white px-3 py-1 rounded-full text-sm font-semibold shadow-md">
//             ₹{price}
//           </div>
...
//         <h3 className="text-3xl font-bold text-green-600">🥦 Vegetarian Delights</h3>
//         <div className="flex items-center space-x-2">
//           <span className="text-base sm:text-lg text-gray-700 font-medium">
//             {showAll ? "Back to All Vegetarian Delights" : "Explore more vegetarian delights"}
//           </span>
//           <button
...
//         {(showAll ? vegData : vegData.slice(0, 4)).map((item, i) => (
