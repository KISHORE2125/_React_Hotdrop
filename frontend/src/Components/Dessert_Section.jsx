...
// import Dark_Chocolate_Dessert from '../assets/Dessert/Dark_Chocolate_Dessert.jpg.jpg';
  ...
  return (
    <div className="relative z-10 px-4">
      ...
      <div className="flex justify-between items-center mb-6">
        <h3 className="text-3xl font-bold text-orange-600">🍨 Desserts</h3>
        <div className="flex items-center space-x-2">
          <span className="text-base sm:text-lg text-gray-700 font-medium">
            {showAll ? "Back to All Dishes" : "Explore more desserts"}
          </span>
          <button
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-2 w-full">
        {(showAll ? dessertsData : dessertsData.slice(0, 4)).map((item, i) => (
